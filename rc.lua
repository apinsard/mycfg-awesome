...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "h",     function () awful.tag.incnmaster( 1)      end), -- useless
    awful.key({ modkey, "Shift"   }, "l",     function () awful.tag.incnmaster(-1)      end), -- useless
    awful.key({ modkey, "Control" }, "h",     function () awful.tag.incncol( 1)         end), -- useless
    awful.key({ modkey, "Control" }, "l",     function () awful.tag.incncol(-1)         end), -- useless
